...
accept_file = open("unit_tests/inputs/1_18b_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_18b_rejects.txt", "r")
...
### Test Inputs ###
from assignment03_main import prob_1_18b
test_machine = NFA.from_regex(prob_1_18b, input_symbols={'0', '1'})
