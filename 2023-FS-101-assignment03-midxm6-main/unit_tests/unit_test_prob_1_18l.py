...
accept_file = open("unit_tests/inputs/1_18l_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_18l_rejects.txt", "r")
...
### Test Inputs ###
from assignment03_main import prob_1_18l
test_machine = NFA.from_regex(prob_1_18l, input_symbols={'0', '1'})
