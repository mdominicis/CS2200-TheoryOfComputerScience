...
accept_file = open("unit_tests/inputs/1_18i_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_18i_rejects.txt", "r")
...
### Test Inputs ###
from assignment03_main import prob_1_18i
test_machine = NFA.from_regex(prob_1_18i, input_symbols={'0', '1'})
