...
accept_file = open("unit_tests/inputs/1_21b_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_21b_rejects.txt", "r")
...
### Test Inputs ###
from assignment04_main import prob_1_21b
test_machine = NFA.from_regex(prob_1_21b, input_symbols={'a', 'b'})
